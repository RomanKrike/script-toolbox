...
| Houdini | Houdini 19+ | PySide2 / Qt 5 on 19–20.x; optional PySide6 / Qt 6 on Houdini 20.5 Qt 6 builds; PySide6 / Qt 6 on 21+ | Python, HScript |

Script Toolbox uses one shared UI implementation across all supported hosts. The runtime compatibility layer selects the host-appropriate Qt/PySide generation, prefers a binding already loaded by the DCC, and keeps the legacy QtGui-style API used by the original Maya 2015 implementation.
