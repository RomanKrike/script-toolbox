...
def test_runtime_binding_hooks_are_installed_through_shared_pipeline():
    source = _source(
    ...
    assert "_decorate_runtime_renderer_registry(registry)" in source
    assert "install_event_binding_hooks(registry)" in renderer_source
